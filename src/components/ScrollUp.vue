<template>
  <div class="scroll-up">
      <svg class="scroll-up__svg" @click="scrollTop()" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
            viewBox="0 0 455.111 455.111" style="enable-background:new 0 0 455.111 455.111;" xml:space="preserve">
        <path class="scroll-up__path" style="fill:#2b87d8;" d="M406.756,455.111h-358.4C21.333,455.111,0,433.778,0,406.756v-358.4C0,21.333,21.333,0,48.356,0
          h358.4c27.022,0,48.356,21.333,48.356,48.356v358.4C455.111,433.778,433.778,455.111,406.756,455.111z"/>
        <path class="scroll-up__path" style="fill:#2b87d8;" d="M366.933,0c-17.067,73.956-61.156,153.6-129.422,221.867C164.978,294.4,78.222,339.911,0,354.133
          V48.356C0,21.333,21.333,0,48.356,0H366.933z"/>
        <g>
          <path class="scroll-up__path" style="fill:#FFFFFF;" d="M287.289,174.933H268.8v71.111c0,7.111-5.689,12.8-12.8,12.8h-56.889c-7.111,0-12.8-5.689-12.8-12.8
          ...
          <path class="scroll-up__path" style="fill:#FFFFFF;" d="M136.533,304.356v78.222h-22.756v-78.222H86.756v-18.489h76.8v18.489H136.533z"/>
          <path class="scroll-up__path" style="fill:#FFFFFF;" d="M258.844,369.778C248.889,379.733,237.511,384,221.867,384c-14.222,0-27.022-4.267-36.978-14.222
          ...
          <path class="scroll-up__path" style="fill:#FFFFFF;" d="M358.4,294.4c7.111,5.689,9.956,14.222,9.956,27.022c0,11.378-2.844,21.333-9.956,27.022
