        ...
        <div class="card-inner">
            <div class="card-header">
                <div class="card-header--top">
                    <div class="card-title" @click="viewTask(task.id)">
                        {{ task.name }}
                    </div>
                    <span
                        class="card-sticker top-right"
            ...
            <font-awesome-icon icon="edit" class="top-icon icon-size-xl" alt="Редактировать задачу"/>
                    ...
                    <a
                        ...
                        class="card-icons--link"
                    >
                        <font-awesome-icon
                            icon="trash"
                            class="top-icon icon-size-xl"
                            alt="Удалить задачу"
                        />
                    </a>
                </div>
...
export default {
        ...
        deleteTask() {
            this.check = new Noty({
                ...
                buttons: [
                    ...
                    Noty.button('Нет', '', () => this.closeCheck(), {
                        id: 'delete-no',
                    }),
                ],
            });
    ...
    */
        dragCard(element) {
            ...
            const columnItems = document.querySelectorAll('.column__items');
            ...
            function dragLeave(e) {
                if (
                    e.toElement !== undefined &&
                    e.toElement.className == 'column__items hovered'
                ) {
                    e.toElement.className = 'column__items';
                }
            }
            function dragDrop(e) {
                let divColumnItems = this.querySelector('.column__items');
                if (divColumnItems) {
                    divColumnItems.prepend(card);
                    columnItems.forEach(
                        (item) => (item.className = 'column__items')
                    );
                }
            }
        },
